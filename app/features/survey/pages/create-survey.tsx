...
export default function CreateSurvey() {
  ...
  const CreateSurvey = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const questions = questionsData.map((q, i) => {
      ...
      return { question: q, options } as const;
    ...
    setSurveyMeta({
      ...
      reward_amount: Number(poolSize) / Number(targetNumber),
      questions,
      owner: address,
    });
  };
  ...
  return (
    <div className="flex justify-center w-full">
      <Card className="w-full max-w-xl">
        <CardHeader>
          <CardTitle className="">Create Survey</CardTitle>
          <CardDescription>
          ...
          >
            ...
            <div className="flex justify-center items-center mb-4">
              ...
              <Button
                type="button"
                onClick={() => addQuestion()}
                className="h-8 w-8 rounded-full mr-1 bg-gray-200 "
              >
                +
              </Button>
            </div>
